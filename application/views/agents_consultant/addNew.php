                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card box-shadow-0" style="padding: 30px;">
                            ...
                            <h2>Add New Agents or Consultant</h2>   
                            ...
                            <?php if (!empty(validation_errors())): ?>
                                ...
                                <?php echo form_open_multipart('agents_consultant/createNewAgent','id="my_id"'); ?>
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="form-group col-12 mb-2">
                                                <label for="donationinput1">Name</label>
                                                <input type="text" class="form-control news-default" name="name" id="name"  placeholder="Enter Name of Agent or Consultant" autocomplete="off" required >
                                        ...
                                        <div class="row"> 
                                            <div class="form-group col-12 mb-2">
                                                ...
                                                <input type="text" class="form-control square" placeholder="Enter Information" name="info">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-12 mb-2">
                                                ...
                                                <input type="text" class="form-control square" placeholder="phone Number one" name="number1">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-12 mb-2">
                                                ...
                                                <input type="text" class="form-control square" placeholder="phone Number two" name="number2">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-12 mb-2">
                                                ...
                                                <input type="email"  class="form-control square" placeholder="Enter Email" name="email">
                                            </div>
                                        </div>
