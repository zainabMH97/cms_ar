  ...
  <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a href=""><i class="la la-plus-circle"></i><span class="menu-title" ><?php echo $this->lang->line('side-add-new-element'); ?></span><span class="badge badge badge-info badge-pill float-right mr-2">2</span></a>
                    <ul class="menu-content">
                        <li><a class="menu-item" href="<?php echo base_url(); ?>uasc/addUasc"><i></i><span ><?php echo $this->lang->line('side-add-new-new'); ?></span></a>
                        </li>
                        <li><a class="menu-item" href="<?php echo base_url(); ?>uasc/editUasc"><i></i><span ><?php echo $this->lang->line('side-edit-new-element'); ?></span></a>
                        </li>
                    </ul>
                </li>

                <li class=" nav-item"><a href=""><i class="la la-plus-circle"></i><span class="menu-title" >Tenders</span><span class="badge badge badge-info badge-pill float-right mr-2">2</span></a>
                    <ul class="menu-content">
                        <li><a class="menu-item" href="<?php echo base_url(); ?>tenders/addTender"><i></i><span >Add New Tender</span></a>
                        </li>
                        <li><a class="menu-item" href="<?php echo base_url(); ?>tenders/editTender"><i></i><span >Edit Tender</span></a>
                        </li>
                    </ul>
                </li>
