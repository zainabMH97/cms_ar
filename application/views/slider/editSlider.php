                                    ...
                                    <?php foreach($slider as $slid) : ?>
                                        ...
                                        <tr>
                                            ...
                                            <?php elseif($fileExtension == 'mp4'): ?>
                                                <?php if(!empty($slid['yt_link'])) :?>
                                                    <td><iframe width="300" height="200" src="https://www.youtube.com/embed/<?php echo $slid['yt_link'];?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></td>
                                                <?php else :?>
                                                    <td>
