                        ...
                        <div class="card box-shadow-0" style="padding: 30px;">
                                ...
                                <?php echo form_open_multipart('slider/createSlider'); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="title" class="form-control subcategory-default" name="title"  placeholder="Enter title">
                                    </div>

                                    <div class="form-group">
                                        <label>YouTube Embeded Link </label>
                                        <input type="text" id="title" class="form-control subcategory-default" name="yt_link"  placeholder="Enter link">
                                    </div>

                                    <div class="form-group">
                                        <label><?php echo $this->lang->line('slider-caption'); ?></label>
                                        <textarea type="text" class="form-control subcategory-default" name="caption"  placeholder="Enter caption" rows="5"></textarea>
                                    </div>
                                    <div class="form-group">
